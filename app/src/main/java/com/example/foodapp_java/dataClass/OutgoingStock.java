...
// Simetris dengan EntryStock, mewakili satu transaksi barang keluar
public class OutgoingStock implements Parcelable {
    ...
    // Catatan: 'supplierId' dan 'supplierName' disimpan untuk simetri,
    // mungkin bisa diartikan sebagai 'tujuan' atau 'keterangan'
    ...
    public OutgoingStock(String id, String foodId, String foodName, Date exp_date, int qty,
    ...
    protected OutgoingStock(Parcel in) {
        id = in.readString();
    ...
    public static final Creator<OutgoingStock> CREATOR = new Creator<OutgoingStock>() {
        @Override
        public OutgoingStock createFromParcel(Parcel in) {
            return new OutgoingStock(in);
        }

        @Override
        public OutgoingStock[] newArray(int size) {
            return new OutgoingStock[size];
        }
    };
