...
public class EntryStockAdapter extends RecyclerView.Adapter<EntryStockAdapter.VH> {
    ...
    public interface OnActionListener {
        void onEdit(StockEntry entry);

        void onDelete(StockEntry entry);
    }

    private Context ctx;
    private List<StockEntry> list;
    private OnActionListener listener;

    public EntryStockAdapter(Context ctx, List<StockEntry> list, OnActionListener listener) {
        this.ctx = ctx;
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        StockEntry e = list.get(position);
    ...
    public void setList(List<StockEntry> newList) {
        this.list = newList;
