...
public class EntryStock implements Parcelable {
    ...
    public EntryStock(String id, String foodId, String foodName, Date exp_date, int qty,
    ...
    protected EntryStock(Parcel in) {
        id = in.readString();
    ...
    public static final Creator<EntryStock> CREATOR = new Creator<EntryStock>() {
        @Override
        public EntryStock createFromParcel(Parcel in) {
            return new EntryStock(in);
        }

        @Override
        public EntryStock[] newArray(int size) {
            return new EntryStock[size];
        }
    };
